//
//  PlayerRequestModal.swift
//  Fringe
//
//  Created by MyMac on 9/18/21.
//
...
// MARK: PlayerRequestModal convenience initializers and mutators

extension PlayerRequestModal {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(PlayerRequestModal.self, from: data)
    }
