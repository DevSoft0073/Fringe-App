...
// MARK: - AddPlayerRequestModal
struct AddPlayerRequestModal: Codable, Hashable {
    ...
    var addPlayerRequestModalDescription, date, status: String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case addPlayerRequestModalDescription = "description"
        case date, status
    }
}

// MARK: AddPlayerRequestModal convenience initializers and mutators

extension AddPlayerRequestModal {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(AddPlayerRequestModal.self, from: data)
    }
